...
function App() {
  ...
  return (
    <div className="site-bg text-white font-sans">
      <nav className="flex justify-between items-center px-8 py-6 max-w-6xl mx-auto">
        <div className="text-2xl font-bold tracking-wider">
          <span className="bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">Nattapong</span>
        </div>
        <ul className="flex space-x-6 text-sm font-medium text-slate-300">
          ...
          <li>
            <a href="#projects" className="hover:text-white/90 transition-colors duration-200">Projects</a>
          </li>
          <li>
            <a href="#skills" className="hover:text-white/90 transition-colors duration-200">Skills</a>
          </li>
          <li>
            <a href="#activity" className="hover:text-white/90 transition-colors duration-200">Activity</a>
          </li>
        </ul>
      </nav>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 md:py-24 flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="w-full md:w-1/2 flex justify-center">
          <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-slate-700 shadow-xl shadow-black/40">
            <img
              src={profileImg}
              alt="Ping Pong"
        ...
        <div className="w-full md:w-1/2 text-center md:text-left space-y-4">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight">
            ผมชื่อ <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">ณัฐพงษ์ จำจด</span>
          </h1>
          <p className="text-xl md:text-2xl text-slate-400 font-light">
            Frontend Developer & UI/UX Designer
          </p>
          <p className="text-slate-400 leading-relaxed max-w-lg">
            ยินดีต้อนรับสู่พอร์ตโฟลิโอของผม! ผมหลงใหลในการสร้างสรรค์เว็บไซต์ที่มีประสบการณ์ผู้ใช้ดีเยี่ยมและสวยงาม
          </p>

          <div className="pt-4 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <a href="#projects" className="accent-btn">ผลงานของผม</a>
            <a href="#about" className="btn text-slate-200 border border-slate-700 px-4 py-2 rounded-lg">เกี่ยวกับผม</a>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="project-card shadow-2xl">
            <button onClick={() => openProjectModal('ฐานข้อมูลระบบบัญชีและธุรกรรมธนาคาร', pro1Images, 0, 'โปรเจกต์แรก: ตัวอย่างการพัฒนาเว็บแอปที่เน้นประสบการณ์ผู้ใช้และการโต้ตอบแบบเรียลไทม์')} className="w-full text-left">
              ...
              <div className="px-6 py-6">
                <div className="font-semibold text-lg mb-2 text-slate-100">ฐานข้อมูลระบบบัญชีและธุรกรรมธนาคาร </div>
          ...
          <div className="project-card shadow-2xl">
            <button onClick={() => openProjectModal('LLM&RAG-Powered Knowledge Assistant Platform', pro2Images, 0, 'โปรเจกต์ที่สอง: ระบบตัวอย่างที่แสดงการเชื่อมต่อ backend และฐานข้อมูล พร้อม UI ที่สวยงาม')} className="w-full text-left">
              ...
              <div className="px-6 py-6">
                <div className="font-semibold text-lg mb-2 text-slate-100">LLM&RAG-Powered Knowledge Assistant Platform</div>
                <p className="text-slate-300 text-sm leading-relaxed">
      ...
      <section id="about" className="max-w-6xl mx-auto px-6 py-16">
        <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-8 shadow-2xl shadow-slate-950/30">
          <h2 className="mb-6 text-3xl font-bold text-blue-400">About Me</h2>
          ...
          <blockquote className="border-l-4 border-blue-500 pl-4 text-xl italic text-slate-200">
      ...
      <section id="skills" ref={skillsRef} className="max-w-6xl mx-auto px-6 py-16">
        <div className="rounded-2xl border border-slate-700 bg-slate-800/60 p-8 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="progress-track mb-4"><div className="progress-fill" style={{ width: skillsVisible ? '90%' : '0%' }} /></div>

              <div className="flex justify-between mb-2">
                <span>JavaScript</span>
                <span className="text-slate-400">85%</span>
              </div>
              <div className="progress-track mb-4"><div className="progress-fill" style={{ width: skillsVisible ? '85%' : '0%' }} /></div>
            </div>
            <div>
              <div className="flex justify-between mb-2">
              ...
              <div className="progress-track mb-4"><div className="progress-fill" style={{ width: skillsVisible ? '88%' : '0%' }} /></div>

              <div className="flex justify-between mb-2">
                <span>UI / UX</span>
                <span className="text-slate-400">80%</span>
              </div>
              <div className="progress-track mb-4"><div className="progress-fill" style={{ width: skillsVisible ? '80%' : '0%' }} /></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="activity" className="max-w-6xl mx-auto px-8 py-16">
        <div className="rounded-2xl border border-slate-700 bg-slate-800/60 p-8 shadow-lg flex flex-col md:flex-row gap-6 items-center">
          <img src={activityImg} alt="เข้าร่วมงาน" className="w-48 h-48 object-cover rounded-lg shadow-md" />
          <div>
            <h2 className="text-2xl font-bold text-blue-400 mb-2">Activity</h2>
      ...
      <div className="floating-cta">
        <button onClick={() => alert('รบกวนรับผมไปพิจารณาพิเศษด้วยครับ ติดต่อ:pongzazaza0@gmail.com')} className="btn-primary">Hire me</button>
      </div>
